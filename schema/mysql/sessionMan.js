...
const tableName = 'sessionMan';
const collate = "utf8_unicode_ci";
const charset = "utf8";
const engine = "InnoDB";
const validScopes = config.auth.validScopes;
const fieldMap = {
    id: "id",
    entityId: "entityId",
...
const createTable = `CREATE TABLE IF NOT EXISTS ${tableName} (
    ...
    ${fieldMap.sessionKey} CHAR(64) DEFAULT NULL,
    ${fieldMap.entityId} binary(16) NOT NULL,
    ${fieldMap.valid} BOOLEAN DEFAULT 0,
    ${fieldMap.expiresOn} BIGINT UNSIGNED NOT NULL,
    ${fieldMap.scope} CHAR(1) DEFAULT NULL,
    ${fieldMap.createdOn} BIGINT UNSIGNED DEFAULT NULL,
    ${fieldMap.updatedOn} BIGINT UNSIGNED DEFAULT NULL,
    UNIQUE KEY unqsessionKey (${fieldMap.sessionKey})
